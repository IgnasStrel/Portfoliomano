...
const projects = [
  {
    ...
    description: "Team project built with PHP and MySQL for a smooth online shopping experience.",
  ...
  },
  {
    id: 3,
    title: "E-commerce Platform",
    description: "Feature-rich platform with user authentication and secure payment processing.",
  ...
  },
  {
    ...
    description: "Clean, responsive site built with Bootstrap for a corporate presence.",
  ...
  },
  {
    id: 5,
    title: "Corporate Informational Website",
    description: "Simple and effective corporate website using Bootstrap and modern CSS.",
